      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          <div className="relative w-20 h-20 mx-auto mb-6">
            <div className="absolute inset-0 border-4 border-[#6b6b45]/30 rounded-full"></div>
            <div className="absolute inset-0 border-4 border-transparent border-t-[#6b6b45] rounded-full animate-spin"></div>
          </div>
          <p className="text-2xl font-bold text-[#44442B] mb-2">Cargando canciones</p>
          <p className="text-[#A89885]">Preparando batalla de {artistName}...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center bg-red-500/10 border border-red-500/50 rounded-xl p-8 max-w-md">
          ...
          <p className="text-[#926149] mb-6">{error}</p>
          <button 
            onClick={fetchTracks}
            className="px-8 py-3 bg-gradient-to-r from-[#44442B] to-[#926149] hover:from-purple-700 hover:to-pink-700 rounded-lg transition-all transform hover:scale-105 font-bold"
          >
            Reintentar
          </button>
        </div>
  ...
  if (winner) {
    ...
    return (
      <div className="max-w-3xl mx-auto animate-[fadeIn_0.5s_ease-out]">
        {/* Card para captura */}
        <div ref={winnerCardRef} className="p-8 rounded-2xl" style={{ backgroundColor: '#ffffff' }}>
          {/* Confetti effect */}
          <div className="text-center mb-8">
            <div className="inline-block animate-[bounce_1s_ease-in-out_3]">
              <div className="text-8xl mb-4">🏆</div>
            </div>
              <h2 className="text-5xl font-black mb-3 animate-[pulse_2s_ease-in-out_infinite]" style={{ color: '#926149', fontFamily: 'Georgia, serif' }}>
              ¡Canción Ganadora!
            </h2>
            <p className="text-xl text-[#A89885]">Tu favorita de {artistName}</p>
          </div>
          <div className="backdrop-blur-xl rounded-2xl overflow-hidden border-2 shadow-2xl" style={{ backgroundColor: '#F5E9E4', borderColor: '#926149', boxShadow: '0 20px 50px rgba(146, 97, 73, 0.2)' }}>
            {/* Imagen del ganador */}
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-white via-transparent to-transparent z-10"></div>
              ...
              />
            <div className="absolute top-4 right-4 px-4 py-2 rounded-full font-black text-sm z-20 animate-[pulse_2s_ease-in-out_infinite]" style={{ backgroundColor: '#926149', color: '#F5E9E4' }}>
                #1 FAVORITA
              </div>
            </div>
            
            <div className="p-8">
              <h3 className="text-4xl font-black mb-2 text-[#44442B]">{winner.name}</h3>
              <p className="text-lg text-[#A89885] mb-8">{winner.albumName}</p>
              
              {/* Estadísticas mejoradas */}
              {trackStats && totalBattles > 0 ? (
                <div className="space-y-6 mb-8">
                  <div className="text-center mb-6">
                    <p className="text-sm text-[#A89885] mb-3 font-medium">RENDIMIENTO GLOBAL</p>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="bg-gradient-to-br from-[#6b6b45]/20 to-[#44442B]/20 border border-[#6b6b45]/30 rounded-xl p-4 text-center">
                      <div className="text-3xl font-black text-purple-300 mb-1">{totalWins}</div>
                      <div className="text-xs text-[#A89885] font-medium">VICTORIAS</div>
                    </div>
                    
                    <div className="bg-gradient-to-br from-pink-500/20 to-[#926149]/20 border border-pink-500/30 rounded-xl p-4 text-center">
                      <div className="text-3xl font-black text-pink-300 mb-1">{totalBattles}</div>
                      <div className="text-xs text-[#A89885] font-medium">BATALLAS</div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 rounded-xl p-4 text-center">
                      ...
                      <div className="text-xs text-[#A89885] font-medium">WIN RATE</div>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#F5E9E4] rounded-lg p-4 border bg-[#F5E9E4]/50 border-[#D1BFA7]">
                    <p className="text-center text-sm text-[#926149]">
                ...
                <div className="bg-gray-800/50 rounded-lg p-6 border border-[#A89885] mb-8 text-center">
                  <p className="text-[#A89885]">¡Eres el primero en elegir esta canción! 🎉</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-6">
          <button 
            onClick={resetGame}
            className="flex-1 px-8 py-4 rounded-xl font-bold text-lg transition-all transform hover:scale-105 shadow-lg text-white"
            style={{ backgroundColor: '#926149' }}
          >
            Jugar de nuevo
          </button>
          ...
          <button 
            ...
            className="flex-1 px-8 py-4 rounded-xl font-bold text-lg transition-all transform hover:scale-105 shadow-lg disabled:opacity-50 text-white"
            style={{ backgroundColor: '#44442B' }}
          >
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="mb-12">
        <div className="flex justify-between items-center mb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-medium text-[#A89885]">Batallas</p>
              <p className="text-xl font-black text-[#44442B]">{tracks.length - remainingTracks.length - 1} / {tracks.length}</p>
            </div>
          </div>
          <div className="text-right">
            <p className="text-sm font-medium text-[#A89885]">Quedan</p>
            <p className="text-xl font-black text-purple-400">{battlesLeft} {battlesLeft === 1 ? 'canción' : 'canciones'}</p>
          </div>
        </div>
        <div className="w-full h-4 rounded-full overflow-hidden border-2 shadow-inner" style={{ backgroundColor: '#ffffff', borderColor: '#A89885' }}>
          <div className="h-full transition-all duration-500 relative" style={{ backgroundColor: '#926149', width: `${progress}%` }}>
      ...
      <div className="text-center mb-12 animate-[fadeIn_0.5s_ease-out]">
        <h2 className="text-4xl md:text-5xl font-black mb-3" style={{ color: '#44442B', fontFamily: 'Georgia, serif' }}>
          ¿Cuál prefieres?
        </h2>
        <p className="text-[#A89885] text-lg">
      ...
      <div className="flex justify-center mb-8 relative z-20">
        <div className="px-8 py-3 rounded-full font-black text-2xl shadow-2xl border-2 animate-pulse" style={{ backgroundColor: '#926149', color: '#F5E9E4', borderColor: '#44442B' }}>
          VS
        </div>
      </div>
          ...
          return (
            <button
              ...
              className={`
                ...
                ${!isSelected && !isRejected ? 'border-[#A89885] hover:border-[#6b6b45] hover:scale-[1.02] shadow-xl' : ''}
            ...
            >
              ...
              {hasPreview && isPlaying && !animating && (
                <div className="absolute top-4 right-4 z-30 bg-green-600 text-[#44442B] px-3 py-2 rounded-full text-xs font-bold flex items-center gap-2 animate-[fadeIn_0.3s_ease-out]">
              ...
              {isSelected && (
                <div className="absolute inset-0 bg-green-500/20 z-30 flex items-center justify-center animate-[fadeIn_0.3s_ease-out]">
                  <div className="bg-green-500 rounded-full p-6 animate-[bounce_0.5s_ease-out]">
                    <svg className="w-16 h-16 text-[#44442B]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="aspect-square overflow-hidden bg-white relative">
                ...
                {/* Número de batalla */}
                <div className="absolute top-4 left-4 bg-black/70 backdrop-blur-sm px-3 py-1 rounded-full text-sm font-bold z-10 text-white">
                  #{index + 1}
                </div>
                  ...
                  <div className="absolute bottom-4 left-4 z-40">
                    {hasPreview ? (
                      <button
                        ...
                        className="bg-black/70 hover:bg-white backdrop-blur-sm px-4 py-2.5 rounded-full text-sm font-bold flex items-center gap-2 transition-all transform hover:scale-110 shadow-2xl border-2 border-[#A89885]"
                      >
                        {isPlaying ? (
                          <>
                      ...
                      <div className="bg-black/70 backdrop-blur-sm px-4 py-2.5 rounded-full text-sm font-bold flex items-center gap-2 shadow-2xl border-2 border-gray-600 opacity-60 text-white">
                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              ...
              {/* Info */}
              <div className="p-6 backdrop-blur-sm" style={{ backgroundColor: '#ffffff' }}>
                <h3 className="text-xl font-bold mb-2 transition-colors line-clamp-2" style={{ color: '#44442B' }}>


                  {track.name}
                </h3>
                <p className="text-sm text-[#A89885] line-clamp-1 mb-4">
                  {track.albumName}
                </p>
                ...
                <div className={`
                  ...
                  ${!animating ? 'bg-[#44442B]/20 group-hover:bg-[#44442B] border border-[#6b6b45]/50' : 'bg-gray-700'}
                `}>
              ...
              {!animating && (
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                  <div className="absolute inset-0 bg-[#6b6b45]/10 blur-xl"></div>
                </div>
              )}
            </button>
          );
      ...
      <div className="mt-12 text-center">
        <p className="text-sm" style={{ color: '#A89885' }}>💡 Consejo: Elige con el corazón, no con la mente</p>
      </div>
    </div>
  );
}